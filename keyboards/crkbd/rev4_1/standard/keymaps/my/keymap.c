...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------+--------|
      _______, S(KC_6), S(KC_4), KC_GRV,  KC_EQL, S(KC_MINS), _______,    _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RIGHT, KC_SCLN, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------+--------|
      _______, S(KC_GRV), S(KC_2), S(KC_3), S(KC_7), S(KC_BSLS),                   KC_SLSH, S(KC_EQL), KC_MINS, S(KC_8), S(KC_5), _______,
  //|--------+--------+--------+--------+--------+--------+-----------------|  |-----------------+--------+--------+--------+--------+--------+--------|
